...
$log[] = "[$now] 上传图片总数：{$stats['upload_images']} 张";
$log[] = "[$now] 系统运行正常";
?>
<!DOCTYPE html>
<html>
...
<div class="wrap">
    <div class="sidebar">
        ...
        <ul class="side-menu">
            ...
            <li class="side-item"><a href="clean_music.php" class="side-link"><i class="fas fa-music"></i> 音乐清理</a></li>
    ...
    <div class="main">
        ...
        <div class="card-box">
            ...
            <div class="card">
                <div class="card-body">
                    <div>
                        <div class="card-title">上传图片总数</div>
                        <div class="card-num"><?=$stats['upload_images']?></div>
                    </div>
